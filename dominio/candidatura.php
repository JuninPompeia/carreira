...
class Candidatura {
	 ...
	 * @return mixed
	 */
	public function getTipoLocalicade() {
		return $this->tipoLocalicade;
	}
	
	/**
	 * @param mixed $tipoLocalicade 
	 * @return self
	 */
	public function setTipoLocalicade($tipoLocalicade): self {
		$this->tipoLocalicade = $tipoLocalicade;
		return $this;
	}
